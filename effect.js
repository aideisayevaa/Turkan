...
$('document').ready(function () {
	...
	$(window).resize(function () {
		...
		$('#b11').animate({ top: 240, left: vw - 30 }, 500);
		$('#b22').animate({ top: 240, left: vw - 20 }, 500);
		$('#b33').animate({ top: 240, left: vw - 10 }, 500);
		$('#b44').animate({ top: 240, left: vw + 10 }, 500);
		$('#b55').animate({ top: 240, left: vw + 20 }, 500);
		$('#b66').animate({ top: 240, left: vw + 30 }, 500);
	...
	$('#story').click(function () {
		...
		function msgLoop(i) {
			$("p:nth-child(" + i + ")").fadeOut('slow').delay(1300).promise().done(function () {
				i = i + 1;
